...
describe('Complete Coupon Lifecycle', function () {
...
describe('Multiple Strategy Management', function () {
...
describe('Edge Cases and Error Handling', function () {
    it('handles invalid strategy gracefully', function () {
        $coupon = Coupon::factory()->create([
            'strategy' => 'non_existent_strategy',
            'active' => true,
        ]);

        expect(coupons()->applyCoupon($coupon))->toBeFalse();
    });
    ...
    it('handles empty payload correctly', function () {
        $coupon = Coupon::factory()->create([
            'payload' => null,
            'active' => true,
        ]);

        expect($coupon->payload)->toBeNull();
        expect(coupons()->isValid($coupon))->toBeTrue();
    });

    it('handles large usage limits', function () {
        $coupon = Coupon::factory()->create([
            'usage_limit' => 999999,
            'active' => true,
        ]);
    ...
    it('handles concurrent consumption attempts', function () {
        $coupon = Coupon::factory()->create([
            'usage_limit' => 1,
            'active' => true,
        ]);
